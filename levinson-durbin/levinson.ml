...
let main () =
  ...
  print_ar_coeffs "Sound /a/" L_dataset.a order;
  print_ar_coeffs "Sound /i/" L_dataset.i order;
  print_ar_coeffs "Sound /u/" L_dataset.u order;
  print_ar_coeffs "Sound /e/" L_dataset.e order;
  print_ar_coeffs "Sound /o/" L_dataset.o order
